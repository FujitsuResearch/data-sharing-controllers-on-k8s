...
import (
	...
	"github.com/FujitsuResearch/data-sharing-controllers-on-k8s/pkg/client/cr/core/clientset/versioned/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.dsc group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) MessageQueues(namespace string) MessageQueueInterface {
	return newMessageQueues(c, namespace)
}

func (c *CoreV1alpha1Client) RdbDatas(namespace string) RdbDataInterface {
	return newRdbDatas(c, namespace)
}

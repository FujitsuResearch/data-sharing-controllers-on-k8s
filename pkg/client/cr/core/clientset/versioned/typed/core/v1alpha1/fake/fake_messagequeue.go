...
var messagequeuesResource = schema.GroupVersionResource{Group: "core.dsc", Version: "v1alpha1", Resource: "messagequeues"}

var messagequeuesKind = schema.GroupVersionKind{Group: "core.dsc", Version: "v1alpha1", Kind: "MessageQueue"}
...
func (c *FakeMessageQueues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MessageQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(messagequeuesResource, c.ns, name), &v1alpha1.MessageQueue{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.MessageQueue), err
}
...
func (c *FakeMessageQueues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MessageQueueList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(messagequeuesResource, messagequeuesKind, c.ns, opts), &v1alpha1.MessageQueueList{})
	...
	list := &v1alpha1.MessageQueueList{ListMeta: obj.(*v1alpha1.MessageQueueList).ListMeta}
	for _, item := range obj.(*v1alpha1.MessageQueueList).Items {
...
func (c *FakeMessageQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(messagequeuesResource, c.ns, opts))
...
func (c *FakeMessageQueues) Create(ctx context.Context, messageQueue *v1alpha1.MessageQueue, opts v1.CreateOptions) (result *v1alpha1.MessageQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(messagequeuesResource, c.ns, messageQueue), &v1alpha1.MessageQueue{})
...
func (c *FakeMessageQueues) Update(ctx context.Context, messageQueue *v1alpha1.MessageQueue, opts v1.UpdateOptions) (result *v1alpha1.MessageQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(messagequeuesResource, c.ns, messageQueue), &v1alpha1.MessageQueue{})
...
func (c *FakeMessageQueues) UpdateStatus(ctx context.Context, messageQueue *v1alpha1.MessageQueue, opts v1.UpdateOptions) (*v1alpha1.MessageQueue, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(messagequeuesResource, "status", c.ns, messageQueue), &v1alpha1.MessageQueue{})
...
func (c *FakeMessageQueues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(messagequeuesResource, c.ns, name, opts), &v1alpha1.MessageQueue{})
...
func (c *FakeMessageQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(messagequeuesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.MessageQueueList{})
	return err
}
...
func (c *FakeMessageQueues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MessageQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(messagequeuesResource, c.ns, name, pt, data, subresources...), &v1alpha1.MessageQueue{})
